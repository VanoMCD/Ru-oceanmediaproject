          ...
          <div className="text-center mb-4">
            ...
            <div className="flex justify-center items-center gap-4 mb-12 flex-wrap">
              ...
              >
                <Button 
                  size="lg" 
                  className="bg-[#0077FF] hover:bg-[#0066DD] text-white shadow-depth hover:shadow-ocean transition-all duration-500 transform hover:scale-105 w-[140px]"
                >
              ...
              >
                <Button 
                  size="lg" 
                  className="bg-red-600 hover:bg-red-700 text-white shadow-depth hover:shadow-ocean transition-all duration-500 transform hover:scale-105 w-[140px]"
                >
                  <svg className="mr-2 h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              >
                <Button 
                  size="lg" 
                  className="bg-[#0078FF] hover:bg-[#0066DD] text-white shadow-depth hover:shadow-ocean transition-all duration-500 transform hover:scale-105 w-[140px]"
                >
                  <svg className="mr-2 h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
